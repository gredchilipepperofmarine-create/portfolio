...
(2,'Game','Shooting Game', 'STG', 'Javascript演習開始直後の自主制作ゲーム2', 'Canvasを用いた描画処理の軽量化と、PHP演習後にスコア保持ロジックを実装', '※制作補助としてAIを使用', '', '20','http://www.gredchilipepper.shop/creates/STG/index.php'),
...
(6,'デモHP', 'C.C.Donuts', 'ccdonuts', 'PHP個人製作課題', 'EC風ショッピングサイト機能の構築', '※制作補助としてAIを使用', '', '80', 'http://www.gredchilipepper.shop/creates/ccdonuts/index.php');
