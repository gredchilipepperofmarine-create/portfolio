      ...
      <div class="col-12 col-md-6 col-lg-4">
        <div class="card-hover-wrapper h-100">
          <button type="button" class="btn text-start p-0 w-100 h-100 card border-0 shadow-custom card-hover-inner rounded-3" data-bs-toggle="modal" data-bs-target="#modal">
            <img src="images/<?= $data_all['repo_name'] ?>.png" class="card-img-top img-fluid rounded-top-3" alt="RPG Demo Pic">
      ...
      <div class="modal-body p-4">
        <div class="row g-4 align-items-start">
          <div class="col-12 col-md-5">
            <img src="images/<?= $data_all['repo_name'] ?>.png" class="img-fluid rounded-3 w-100 shadow-sm" alt="RPG">
          ...
          <div class="col-12 col-md-7 d-flex flex-column justify-content-between">
            ...
            <div class="d-flex flex-column flex-sm-row flex-md-column flex-lg-row gap-2">
              <a href="https://github.com/gredchilipepperofmarine-create/<?= $data_all['repo_name'] ?>.git" target="_blank" rel="noopener noreferrer" class="btn btn-light border shadow-sm d-inline-flex align-items-center justify-content-center gap-2 rounded-3 px-3 py-2 flex-fill text-dark text-decoration-none">
                <img src="images/GitHub_Invertocat_Black.png" alt="GitHub Logo" style="height: 20px; width: auto;">
                <span class="fw-bold">コードを見る</span>
              </a>
              <a href="<?= $data_all['root_pass'] ?>" target="_blank" class="btn btn-primary rounded-3 px-3 py-2 flex-fill d-inline-flex align-items-center justify-content-center">
                作品をプレイする
              </a>
